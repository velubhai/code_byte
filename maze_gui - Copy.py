...
class MazeGUI:
    def __init__(self, rows: int = 10, columns: int = 10, sparseness: float = 0.2,
                 start: MazeLocation = MazeLocation(0, 0), goal: MazeLocation = MazeLocation(6, 9)) -> None:
    ...
    def _setup_GUI(self):
        ...
        style.configure("BG.TLabel", foreground="red", font=('Helvetica', 26))
        style.configure("BG.TButton", foreground="red", font=('Helvetica', 26))
        style.configure("BG.TListbox", foreground="red", font=('Helvetica', 26))
        style.configure("BG.TCombobox", foreground="red", font=('Helvetica', 26))
